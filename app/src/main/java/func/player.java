	...
	public static void mPlayer(String filepath , Activity activity){
		...
		if(!reg.getBack(filepath, "((\\.mp4|\\.webm|\\.ogg|\\.mpK|\\.avi|\\.mkv|\\.flv|\\.mpg|\\.wmv|\\.vob|\\.ogv|\\.mov|\\.qt|\\.rm|\\.rmvb\\.|\\.asf|\\.m4p|\\.m4v|\\.mp2|\\.mpeg|\\.mpe|\\.mpv|\\.m2v|\\.3gp|\\.f4p|\\.f4a|\\.f4b|\\.f4v)$)").isEmpty()){
			...
			try {
				...
				if(func.getlistpackage.doesPackageExist("com.google.android.gallery3d", activity)){
				...
				}else if(func.getlistpackage.doesPackageExist("com.android.gallery3d", activity)){
				...
				}else if(func.getlistpackage.doesPackageExist("com.cooliris.media", activity)){
